...
<html>
    ...
    <body style="text-align: center">
        ...
        $ap=$_POST['comentario'];
            ...
            //Senetncia para agregar una nueva consulta
            $sql = "INSERT INTO consulta (idconsulta, titulo, descripcion, autor)".
                    "VALUES (null,'$tema', '$ap', '$autorTema')";           
            echo "<p>";
